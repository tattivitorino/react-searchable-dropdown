...
export type TSearchOptionKeys<T extends TDropdownOption> = T extends {
    label: string;
    value: string;
} ? Array<Extract<keyof T, string>> : never;
...
type TSearchableBase<T extends TDropdownOption, G> = {
    ...
    DropdownIcon?: FunctionComponent<{
        toggled: boolean;
    }>;
    context?: G;
    inputId?: string;
} & TCommonClasses & TGroups<T, G>;
...
export type TSearchableDropdown<T extends TObjectLikeDropdownOption | TStringDropdownOption, G> = [
    T
] extends [TObjectLikeDropdownOption] ? TSearchableCommon<T, G> & {
...
export type TSearchableDropdownMulti<T extends TObjectLikeDropdownOption | TStringDropdownOption, G> = [T] extends [TObjectLikeDropdownOption] ? TSearchableCommonMulti<T, G> & {
    searchOptionKeys: Array<Extract<keyof T, string>>;
} : TSearchableCommonMulti<T, G> & {
    searchOptionKeys?: undefined;
};
export type TSearchableDropdownProps<T extends TDropdownOption, G = unknown> = TSearchableCommon<T, G> & {
    searchOptionKeys?: Array<Extract<keyof T, string>>;
};
export type TSearchableDropdownMultiProps<T extends TDropdownOption, G = unknown> = TSearchableCommonMulti<T, G> & {
    searchOptionKeys?: Array<Extract<keyof T, string>>;
};
export {};
